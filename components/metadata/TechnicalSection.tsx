...
export default function TechnicalSection({ metadata }: TechnicalSectionProps) {
  ...
  const SimpleListItem = ({
    ...
    const statusText =
      status === 'good' ? 'Good' : status === 'warning' ? 'Warning' : 'Missing'
    ...
    <div className="w-full space-y-10">
      ...
      <div className="space-y-6">
        ...
        <SimpleListItem
          icon='🔒'
          label='HTTPS'
          value={metadata.url.startsWith('https://') ? 'Secure' : 'Insecure'}
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='flex-1 min-w-0'>
                ...
                <p className='analysis-text-xs text-muted-foreground mt-3 pl-3 border-l-2 border-border/40'>
                  Icons help browsers display your site in tabs, bookmarks, and
                  shortcuts
                </p>
              </div>
            </div>
              ...
              <div className='flex-1 min-w-0'>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    {analytics.googleTagManager.present &&
                      analytics.googleTagManager.containerIds.length > 0 && (
                        <div className='flex gap-1'>
